...
class GameMain:
    ...
    def render(self):
        ...
        if self.game_state == 'start':
            ...
            t_press_enter_begin = self.small_font.render('Players VS Strong AI', False, (255, 255, 255))
            ...
            if self.serving_player == 2 :
                t_serve = self.small_font.render("Strong AI" + "'s serve!", False, (255, 255, 255))
            ...
            if self.serving_player == 1 :            
                t_win = self.large_font.render("Strong AI" + "'s wins!", False, (255, 255, 255))
